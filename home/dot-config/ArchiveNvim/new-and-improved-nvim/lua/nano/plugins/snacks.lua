return {
  -- HACK: docs @ https://github.com/folke/snacks.nvim/blob/main/docs
  {
    ...
    opts = {
      ...
      --     command = "magick"
      --   },
      --   img_dirs = { "img", "images", "assets", "static", "public", "media", "attachments","Archives/All-Vault-Images/", "~/Library", "~/Downloads","~/Pictures" },
      -- },
      -- dashboard = {
      --   enabled = true,
      --   sections = {
    ...
    keys = {
      ...
      -- Other Utils
      { "<leader>oc" , function() require("snacks").picker.colorschemes({ layout = "ivy" }) end, desc = "Pick Color Schemes"},
  ...
  -- NOTE: todo comments w/ snacks
  {
    ...
    keys = {
      ...
      { "<leader>fN", function() require("snacks").picker.todo_comments({ keywords = { "NOTE" } }) end, desc = "Todo/Fix/Fixme" },
    },
  }
}
