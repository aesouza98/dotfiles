return {
  ...
  config = function()
    ...
    local utils = require("opts.functions")
    ...
    local project_buttons = {
      ...
      dashboard.button(
        "p a",
        "  EBANX Apps",
        ":lua require('opts.functions').open_project_at('~/Git/Apps/')<CR>"
      ),
      dashboard.button(
        "p c",
        "  CloudOps",
        ":lua require('opts.functions').open_project_at('~/Git/CloudOps/')<CR>"
      ),
      dashboard.button(
        "p p",
        "  EBANX Projects",
        ":lua require('opts.functions').open_project_at('~/Git/Projects/')<CR>"
      ),
      dashboard.button(
        "p d",
        "  Dotfiles",
        ":lua require('opts.functions').open_project_at('~/.dotfiles/')<CR>"
      ),
    }
