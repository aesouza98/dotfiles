return {
	...
	config = function()
		...
		vim.keymap.set("n", "<leader>ft", "<cmd>TodoTelescope<cr>", { desc = "Find Todos on current project" })
		vim.keymap.set("n", "<leader>fT", "<cmd>TodoQuickFix<cr>", { desc = "Find Todos on current project" })
	end,
}
