...
-- Clock
local date            = wibox.widget.textclock("%A, %d de %B - %H:%M")
local dateicon        = wibox.widget.textbox(markup(beautiful.fg_accent, " "))
local clock           = wibox.widget.textclock("%H:%M")
local clockicon       = wibox.widget.textbox(markup(beautiful.fg_accent, " "))
